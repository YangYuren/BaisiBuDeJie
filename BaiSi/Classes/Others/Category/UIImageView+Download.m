...
-(void)xmg_setOriginImageWithURL:(NSString *)image1 andThumbnailImageWithURL:(NSString *)image0 placeholderImage:(UIImage *)placeholder{
    // 根据网络状态来加载图片
    ...
    if (originImage!=nil) {
        ...
        if(mgr.isReachableViaWiFi){
            //wifi直接下载
            [self sd_setImageWithURL:[NSURL URLWithString:image1] placeholderImage:placeholder];
            ...
            if(downloadOriginImageWhen3GOr4G){
                ...
                [self sd_setImageWithURL:[NSURL URLWithString:image0] placeholderImage:placeholder];
            }
        }else{ // 没有可用网络
